...
export default {
  ...
  query: async (req, res, next) => {
    try {
      const reg = await models.Ingreso.findOne({ _id: req.query._id }) // la propiedad _id la añade mongo a cada coleccion
  ...
  // listamos los Ingresos por busqueda
